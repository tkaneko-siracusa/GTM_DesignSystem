...
export const gradients = {
  /** ブランドグラデーション（ティール系） */
  brand: 'linear-gradient(135deg, #1BA491, #2fd4ba)',
  /** ブランドグラデーション（薄め・背景用） */
  brandSubtle: 'linear-gradient(135deg, #f0fdfb, #cdfbf0)',

  /** ダーク背景用グロー（プライマリ） */
  glowPrimary: 'radial-gradient(ellipse at center, rgba(27,164,145,0.15), transparent 70%)',
  /** ダーク背景用グロー（アクセント） */
  ...
  /** テキストグラデーション（ブランド） */
  textBrand: 'linear-gradient(90deg, #1BA491, #3b82f6)',
  /** テキストグラデーション（ニュートラル） */
